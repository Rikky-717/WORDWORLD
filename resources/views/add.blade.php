                ...
                <div class="w-full max-w-xl mx-auto">
                    <form method="POST" action="{{ route('words.store') }}" class="flex flex-col space-y-4">
                        ...
                        <div>
                            ...
                            <x-input-error :messages="$errors->get('meaning')" class="mt-2 text-left" />
                        </div>
                        <div>
                            ...
                            <textarea x-data="{ 
                                ...
                                name="other"
                                class="flex w-full h-auto min-h-[80px] px-3 py-2 text-sm bg-white border rounded-md border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50"></textarea>
                            <x-input-error :messages="$errors->get('other')" class="mt-2 text-left" />
                        </div>
                        <div>
                            <input type="submit" value="add" name="submit" class="py-3 px-5 mt-3 block md:w-2/5 w-4/5 mx-auto bg-gray-900 hover:bg-gray-800 text-white rounded-full text-lg disabled:opacity-50 disabled:pointer-events-none transition duration-500 ease-in-out">
                        </div>
                    </form>
                </div>
            </div>
